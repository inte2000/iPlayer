...
/**
Client API:
Find an effect from the effects chain, returns an effect if successful.
@returns an effect if successful.
*/
//orbit 20250917
LSX_RETURN_OPT
sox_effect_t*
...
sox_get_effect(
    LSX_PARAM_INOUT sox_effects_chain_t* chain, /**< Effects chain to which effect should be added . */
    LSX_PARAM_INOUT const char* name /**< Effect name. */
);
...
void
LSX_API
sox_set_rate_effect_flush_sign(LSX_PARAM_INOUT sox_effect_t* effp);

//orbit 20250917
LSX_RETURN_OPT
void
LSX_API
sox_set_reverb_effect_param(sox_effect_t* effp, sox_bool wetonly, int reverberance,
    int hf_dampling, int roomscale, int stereodepth, int predelay, double wetgain);
